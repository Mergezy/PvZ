...
public class MainActivity extends AppCompatActivity {
    ...
    public void goToAchivePage(View view) {
        Intent intent = new Intent(this, achivePage.class);
        startActivity(intent);
    }
    public void goToSicretPage(View view) {
        Intent intent = new Intent(this, sicretPage.class);
        startActivity(intent);
    }
}